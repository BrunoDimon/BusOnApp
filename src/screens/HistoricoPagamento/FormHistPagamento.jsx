            ...
            <ModalContent>
                ...
                <ModalBody>
                    <ScrollView>
                        ...
                        <InputSelect label={'Usuario'} selectValues={usuarios} inputOnChange={(value) => handleChangeInputValues('usuario_id', value)} isRequired={true} inputValue={usuarios.find(v => v.value === inputValues.usuario_id)?.label} isLoading={isLoadingUsuarios} />
